  ...
  if(!this->player){
   for(int y=0;y<6;y++){
    for(int x=0;x<5;x++){
        ...
        switch(btype){
          case 1:
            value-= wpawntable[y][x]; break;
          case 2:
            value-= wrooktable[y][x]; break;
          case 3:
            value-= wknighttable[y][x]; break;
          case 4:
            value-= wbishoptable[y][x]; break;
          case 5:
            value-= wqueentable[y][x]; break;
          case 6:
            value-= wkingtable[y][x]; break;
          default:
            break;
        }
    }
